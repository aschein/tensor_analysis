...
lookupdrug_file = "../../joyce_repo/data/lookupDrug.py"



execfile(lookupdrug_file)
...
for genericname in l_unique_meds:
    ...
    if not genericname in d_meds_classes:
        ...
        if t_ping_rxnorm[1] != None:
            d_meds_classes[genericname] = getDrugCat(genericname)[1]['root'] #look up the category using the generic name; store a LIST of all roots!
